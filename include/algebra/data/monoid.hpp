...
struct sum_monoid {
    ...
    constexpr sum_monoid(N n) noexcept(
            std::is_nothrow_copy_constructible<N>::value)
            : value(n) {}
...
struct monoid<sum_monoid<N>> {
    ...
    static constexpr sum_monoid<N> mappend(const sum_monoid<N> &a,
                                           const sum_monoid<N> &b) {
        return a + b;
    }
};
...
struct prod_monoid {
    ...
    constexpr prod_monoid(N n) noexcept(
            std::is_nothrow_copy_constructible<N>::value)
            : value(n) {}
...
struct monoid<prod_monoid<N>> {
    ...
    static constexpr prod_monoid<N> mappend(const prod_monoid<N> &a,
                                            const prod_monoid<N> &b) {
        return a * b;
    }
};
}
